 ...
 * FPSモードのコントローラ。
 */
class FPSController extends A3Controller implements Runnable {
    boolean upKey = false;
    ...
    public void run() {
        ...
        Vector3d v = a3canvas.getCameraTargetLoc();
        double y = v.y;
        ...
        v = a3canvas.getCameraTargetLoc();
        v.y = y;
        a3canvas.setCameraLoc(v);
    }
